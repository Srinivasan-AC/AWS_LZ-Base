...
resource "aws_sns_topic" "this" {
  ...
  display_name                = replace(var.sns_topic_name, ".", "-") # dots are illegal in display names and for .fifo topics required as part of the name (AWS SNS by design)
