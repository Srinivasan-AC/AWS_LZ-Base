...
variable "enabled_security_hub" {
  description = "whether to create seuroty hub or not"
  type        = bool
  default     = true
}
...
variable "sqs_dlq_enabled" {
  description = "SQS DLQ enabled or not"
  type        = bool
  default     = false
}
...
variable "cloudwatch_er_securityhub" {
  type        = string
...
variable "cloudwatch_event_rules_security_hub_tags" {
