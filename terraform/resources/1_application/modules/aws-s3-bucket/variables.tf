variable "enabled" {
  type        = bool
  default     = true
  description = "Set to `true` to create an S3 bucket resources"
  nullable    = false
}
...
variable "replication_role_name" {
  type        = string
  default     = ""
  description = "Specify replication IAM Role Name"
}

variable "replication_policy_name" {
  type        = string
  default     = ""
  description = "Specify replication IAM Policy Name"
}
#############################################################################################################
                                         # SQS variables
##############################################################################################################
...
variable "sqs_queue_name" {
  type        = string
  description = "Specify the SQS Queue Name."
  default     = "SQS"
}
